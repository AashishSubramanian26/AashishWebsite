export const gameDevProjects = {
  "the-shifter": {
    ...
    cardImgSrc: "../src/images/game-dev-projects/shifter2.png",
    mediaContent: [
      // "../src/images/game-dev-projects/visiongrunt.mov",
      "../src/images/game-dev-projects/beetle-bistro2.png",
      "../src/images/game-dev-projects/midnight-cram2.png",
      // "../src/images/game-dev-projects/visiongrunt.mov",
      "../src/images/game-dev-projects/beetle-bistro2.png",
      "../src/images/game-dev-projects/midnight-cram2.png",
      // "../src/images/game-dev-projects/visiongrunt.mov",
  ...
  "beetle-bistro": {
    ...
    genre: ["Combat", "Action", "Multiplayer"],
    developmentTools: ["Unity", "Blender"],
    keyFeatures: [
    ...
    cardImgSrc: "../src/images/game-dev-projects/beetle-bistro2.png",
    mediaContent: [
      "../src/images/game-dev-projects/shifter2.png",
      "../src/images/game-dev-projects/beetle-bistro2.png",
      "../src/images/game-dev-projects/midnight-cram2.png",
    ],
    summary:
  ...
  "midnight-cram": {
    ...
    cardImgSrc: "../src/images/game-dev-projects/midnight-cram2.png",
    mediaContent: [
      "../src/images/game-dev-projects/shifter2.png",
      "../src/images/game-dev-projects/beetle-bistro2.png",
      "../src/images/game-dev-projects/midnight-cram2.png",
